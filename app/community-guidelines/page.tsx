...
export const metadata: Metadata = { title: 'Community Guidelines', description: 'Fantasy MPL community, creator, chat, and fair-play standards.' };
...
export default function CommunityGuidelinesPage() {
  return <LegalPage title="Community Guidelines" intro="Fantasy MPL is built for competitive but respectful regional esports communities. Participation requires fair play and responsible communication." sections={[
    ...
    { title: 'Chat and creator spaces', paragraphs: ['League commissioners and verified creators may moderate their community spaces. Platform administrators may remove messages, mute users, preserve moderation records, or suspend accounts when necessary.'] },
    { title: 'Creator verification', paragraphs: ['Verification confirms that a creator identity was reviewed. It is not an endorsement of every statement, prediction, sponsor, or external link published by that creator.'] },
