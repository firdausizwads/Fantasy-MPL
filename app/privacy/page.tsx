...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy" intro="This policy explains what information Fantasy MPL collects, why it is used, and which profile details are public or private." sections={[
    ...
    { title: 'Analytics and performance', paragraphs: ['Fantasy MPL uses Vercel Analytics and Speed Insights to understand page usage, loading performance, and device-level reliability. These tools must not be configured to collect passwords, addresses, dates of birth, private profile fields, draft chat contents, or prediction selections.'] },
